...
final class Barcode39 {
	...
	public function draw($filename = null) {
		...
		if($filename) {
			if( substr_compare($filename, 'png', -3, 3) && function_exists("imagepng") )
				imagepng($img, $filename);
			if( (substr_compare($filename, 'jpg', -3, 3) || substr_compare($filename, 'jpeg', -4, 4) ) && function_exists("imagejpeg") )
